...
library(pacman)
p_load(tidyverse, entropy, tictoc)
...
test run
```{r}
test_path <- "data/ntr/test.csv"

tic()
calculate_ntr(test_path, w = 1)
toc()

# subset_paths <- list.files(path = "data/ntr/", pattern = "_to", full.names = T)
# tic()
# lapply(subset_paths, calculate_ntr, w = 1)
# toc()
```
